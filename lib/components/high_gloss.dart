...
class HighGloss extends StatelessWidget {
  const HighGloss({super.key});
    ...
    return const Scaffold(
      body: Column(
        children: [
          ...
          // wait accordion
          Accordion(title: 'Wait', content: 'Epoxy resin is all about control. If you let the Haksons Ultra Clear sit for about 10 minutes, it`ll become slightly thicker which will give you a very good control. As you keep it for longer, you will get better control and lacing. The Haksons High Gloss can allow a working time of almost 15 minutes in the container and about 1 hour on the canvas surface.'),
        ],
      ),
    );
  }
